  ...
  namespace TestSuite
  {
    ...
    public:
     ...
     // void initIK();
      ...
      void startOnLineWalkingNaveau(PatternGeneratorInterface &aPGI);
      void startOnLineWalkingHerdt(PatternGeneratorInterface &aPGI);
      void StartAnalyticalOnLineWalkingMorisawa(PatternGeneratorInterface &aPGI);
      
   //   yarp::os::BufferedPort<yarp::os::Bottle>  PG_data_out;
      
   //   yarp::os::BufferedPort<yarp::os::Bottle>  PG_command_in;
    ...
    int iteration ;
      ...
      void generateEventNaveau();
      
      void generateEventHerdt();

      bool generateEventMorisawa();
    ...
    public :
      ...
      {
        std::istringstream strm2(":setVelReference  0.02 0.0 -0.04");
        aPGI.ParseCmd(strm2);
      }
      ...
      {
        std::istringstream strm2(":setVelReference  0.08 0.0 0.0");
        aPGI.ParseCmd(strm2);
      }
